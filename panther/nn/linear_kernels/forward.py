...
@triton.autotune(
    ...
    triton.Config({'BLOCK_SIZE_BSIZE': 128, 'BLOCK_SIZE_K': 128, 'BLOCK_SIZE_D2': 512, 'GROUP_SIZE_BSIZE': 8}, num_stages=4, num_warps=16),
    triton.Config({'BLOCK_SIZE_BSIZE': 512, 'BLOCK_SIZE_K': 512, 'BLOCK_SIZE_D2': 512, 'GROUP_SIZE_BSIZE': 8}, num_stages=4, num_warps=16),
    triton.Config({'BLOCK_SIZE_BSIZE': 512, 'BLOCK_SIZE_K': 512, 'BLOCK_SIZE_D2': 512, 'GROUP_SIZE_BSIZE': 8}, num_stages=0, num_warps=32),
    triton.Config({'BLOCK_SIZE_BSIZE': 512, 'BLOCK_SIZE_K': 512, 'BLOCK_SIZE_D2': 512, 'GROUP_SIZE_BSIZE': 8}, num_stages=4, num_warps=32),
],
...
@triton.autotune(
    ...
    triton.Config({'BLOCK_SIZE_BSIZE': 128, 'BLOCK_SIZE_D1': 128, 'BLOCK_SIZE_K': 512, 'GROUP_SIZE_BSIZE': 8}, num_stages=4, num_warps=16),
    triton.Config({'BLOCK_SIZE_BSIZE': 512, 'BLOCK_SIZE_D1': 512, 'BLOCK_SIZE_K': 512, 'GROUP_SIZE_BSIZE': 8}, num_stages=4, num_warps=16),
    triton.Config({'BLOCK_SIZE_BSIZE': 512, 'BLOCK_SIZE_D1': 512, 'BLOCK_SIZE_K': 512, 'GROUP_SIZE_BSIZE': 8}, num_stages=0, num_warps=32),
],
    key=['BSIZE', 'd1', 'K', 'L'],
)
@triton.jit
